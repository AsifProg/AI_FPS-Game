...
namespace InfimaGames.LowPolyShooterPack
{
	...
	{
		[SerializeField] private CharacterAnimatorController m_AnimatorController;
		...
		private void Fire()
		{
			...
			Ray ray = cameraWorld.ScreenPointToRay(new Vector3(Screen.width / 2f, Screen.height / 2f));
				    ...
				    Mathf.Infinity,mask))
			{
				...
				if (hit.transform.TryGetComponent(out HealthController healthController))
				{
					...
					healthController.ApplyDamage(50);
				}
			}
